...
public class CartController {
    ...
    void btnViewStorePressed(ActionEvent event) {
    	try {
            ...
            alert.setHeaderText("Could not load the store interface");
            alert.setContentText("An error occurred while loading the store view.\nDetails: " + e.getMessage());
            alert.showAndWait();
    	}
    }
    ...
    void placeOrderButtonPressed(ActionEvent event) {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            cancelAlert.setContentText("Your order was not placed.");
